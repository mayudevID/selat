...
class RegencyAdapter(private val context: Context, private var listRegency: ArrayList<Regency>) : BaseAdapter() {
    ...
    override fun getCount() = listRegency.size

    override fun getItem(p0: Int) = listRegency[p0]
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        vh.label.text = getCapsSentences(listRegency[p0].name.lowercase())
        return newView
    }

    fun refreshData(newList : ArrayList<Regency>) {
        listRegency.clear()
        listRegency = newList
